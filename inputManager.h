...
static void glfw_key_callback(GLFWwindow* window, int key, int scancode, int action, int modifier)
{
	...
	if (key == GLFW_KEY_ESCAPE && action == GLFW_PRESS)
		...
		case GLFW_KEY_UP:
			...
			scn->change_snake_direction(Eigen::Vector3d(0, 1, 0));
		...
		case GLFW_KEY_LEFT:
			...
			scn->change_snake_direction(Eigen::Vector3d(1, 0, 0));
		...
		case'0':
			...
			scn->data_list[0].MyTranslate(*scn->getTip(0), true);
			break;
		case '1':
			scn->data_list[0].resetTranslation();
			scn->data_list[0].MyTranslate(*scn->getTip(1), true);
			break;
		case '2':
			scn->data_list[0].resetTranslation();
			scn->data_list[0].MyTranslate(*scn->getTip(2), true);
			break;
		case '3':
			scn->data_list[0].resetTranslation();
			break;
